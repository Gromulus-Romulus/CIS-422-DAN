...
class QuizForm(FlaskForm):
    ...
    myField3 = SelectField('Do you have roommates?', choices=((0,"none"), (1,"1 to 2"), (2,">2")))
    ...
    myField13 = SelectField('How friendly/protective do you want your dog to be?', choices=((0,"very protective"), (1,"moderately protective/friendly"), (2,"very friendly")))
