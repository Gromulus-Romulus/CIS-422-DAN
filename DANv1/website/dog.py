...
class Dog:
    def __init__(self, ID, name, age, weight, sex, breed, notes, neuspay, walks, barking, trained, training_time, yard_requirement, friendly, energy, attention_requirement, good_with_pets, good_with_kids, shedding, size, photo):
        self.id = ID
